package com.icool.reader.http.observer;
...
import static com.icool.reader.http.observer.DefaultObserver.ExceptionReason.BAD_NETWORK;
import static com.icool.reader.http.observer.DefaultObserver.ExceptionReason.CONNECT_ERROR;
import static com.icool.reader.http.observer.DefaultObserver.ExceptionReason.CONNECT_TIMEOUT;
import static com.icool.reader.http.observer.DefaultObserver.ExceptionReason.PARSE_ERROR;
import static com.icool.reader.http.observer.DefaultObserver.ExceptionReason.UNKNOWN_ERROR;
...
public abstract class DefaultObserver<T> implements Observer<BaseHttpResult<T>> {
    ...
    protected void onFail(BaseHttpResult<T> result) {
        ...
        if (TextUtils.isEmpty(message)) {
            Logger.e(TAG, "onFail -> message is empty");
        } else {
            Logger.e(TAG, "onFail -> " + message);
        }
    }
